...
@cleanunicorn/mythos/0.3.2 linux-x64 node-v11.11.0
$ mythos --help [COMMAND]
USAGE
  $ mythos COMMAND
...
...
_See code: [src/commands/analyze.ts](https://github.com/cleanunicorn/mythos/blob/v0.3.2/src/commands/analyze.ts)_
