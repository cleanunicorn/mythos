...
_See code: [src/commands/analyze.ts](https://github.com/cleanunicorn/mythos/blob/v0.9.0/src/commands/analyze.ts)_
...
_See code: [src/commands/get-analysis.ts](https://github.com/cleanunicorn/mythos/blob/v0.9.0/src/commands/get-analysis.ts)_
