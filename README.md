...
@cleanunicorn/mythos/0.10.1 linux-x64 node-v11.15.0
$ mythos --help [COMMAND]
USAGE
  $ mythos COMMAND
...
...
_See code: [src/commands/analyze.ts](https://github.com/cleanunicorn/mythos/blob/v0.10.1/src/commands/analyze.ts)_
...
_See code: [src/commands/get-analysis.ts](https://github.com/cleanunicorn/mythos/blob/v0.10.1/src/commands/get-analysis.ts)_
